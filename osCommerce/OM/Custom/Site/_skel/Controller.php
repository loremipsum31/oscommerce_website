<?php
  namespace osCommerce\OM\Core\Site\SITE_ID;
  ...
  use osCommerce\OM\Core\Site\Website\Language;
  use osCommerce\OM\Core\Site\Website\Template;

  class Controller implements \osCommerce\OM\Core\SiteInterface {
    protected static $_default_application = 'APPLICATION_ID';
    ...
    public static function initialize() {
      ...
      $application = 'osCommerce\\OM\\Core\\Site\\SITE_ID\\Application\\' . OSCOM::getSiteApplication() . '\\Controller';
